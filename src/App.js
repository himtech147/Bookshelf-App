...
class BooksApp extends React.Component {
	...
	filterBooksBy = this.filterBooks(this.state.books);
						...
						<div className="list-books-content">
							<div>
								<BookShelf
									...
									shelfBooks={this.filterBooksBy("currentlyReading")}
								></BookShelf>
								<BookShelf
									shelfTitle="Want to Read"
									shelfBooks={this.filterBooksBy("wantToRead")}
								></BookShelf>
								<BookShelf
									shelfTitle="Read"
									shelfBooks={this.filterBooksBy("read")}
								></BookShelf>
							</div>
						</div>
